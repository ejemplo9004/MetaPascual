...
Shader "MallaReja"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_Fondo("Fondo", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Fondo = IN.ase_texcoord7.xy * _Fondo_ST.xy + _Fondo_ST.zw;
				float4 tex2DNode8 = tex2D( _Fondo, uv_Fondo );
				
				float temp_output_10_0 = ( 1.0 - tex2DNode8.g );
				...
				float AlphaClipThreshold = temp_output_10_0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Fondo = IN.ase_texcoord2.xy * _Fondo_ST.xy + _Fondo_ST.zw;
				float4 tex2DNode8 = tex2D( _Fondo, uv_Fondo );
				float temp_output_10_0 = ( 1.0 - tex2DNode8.g );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Fondo = IN.ase_texcoord3.xy * _Fondo_ST.xy + _Fondo_ST.zw;
				float4 tex2DNode8 = tex2D( _Fondo, uv_Fondo );
				float temp_output_10_0 = ( 1.0 - tex2DNode8.g );
...
/*ASEBEGIN
Version=18935
0;73.6;919;439;1022.04;217.5159;1.684043;True;False
Node;AmplifyShaderEditor.SamplerNode;8;-503.0472,-20.92802;Inherit;True;Property;_Fondo;Fondo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;10;-80.66028,120.9768;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
